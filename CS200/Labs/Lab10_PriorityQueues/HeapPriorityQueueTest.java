...
/**
 * A JUnit test case class for class TJWHeapPriorityQueue  
 * 
 * @author Imad M Rahal
...
public class HeapPriorityQueueTest {
  ...
  @Before
  public void init(){
    nonEmptyPQ = new TJWHeapPriorityQueue<Integer>();
    emptyPQ = new TJWHeapPriorityQueue<Integer>(5);
  ...
  public void testConstructorFailsNegativeCapacity(){
    emptyPQ = new TJWHeapPriorityQueue<Integer>(-1);
  }
  @Test(expected=IllegalArgumentException.class)
  public void testConstructorFailsZeroCapacity(){
    emptyPQ = new TJWHeapPriorityQueue<Integer>(0);
  }
