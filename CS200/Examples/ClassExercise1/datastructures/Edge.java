...
public class Edge implements Comparable<Edge>{
  ...
  /** Compares the edges by comparing the weights
    * @param otherEdge The other edge with which we're 
    *         comparing this edge object to compare to
      @return the value 0 if the weights are equal 
              a value less than 0 if this weight is numerically 
                  greater than the weight of otherEdge
              a value greater than 0 if this weight is numerically 
                  less than the weight of otherEdge
   */
