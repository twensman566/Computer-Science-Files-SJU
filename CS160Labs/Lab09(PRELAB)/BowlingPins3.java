 ...
 */
public class BowlingPins3 extends GCompound
{
  // The size of a pin
   ...
   */
  public BowlingPins3(int numRows)
  {
    int g = 0;
  ...
  public void setFalse(int total)
  {
    System.out.println(total);
    for( int i = 0; i<total; i++)
    {
      this.pin[i].setColor(Color.WHITE);
      
    }
    this.score = new GLabel("SCORE: " + total, 600, 50);
    this.score.setVisible(true);
    this.add(this.score,400,30);
  }
